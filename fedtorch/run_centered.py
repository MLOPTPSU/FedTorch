...
def main(args):
    ...
    MODEL={'epsilon':'logist_regression', 'MSD':'least_square', 'cifar10':'mlp', 'emnist':'mlp', 'mnist':'mlp',
    'synthetic':'robust_least_square','fashion_mnist':'logist_regression', 'adult':'mlp','shakespeare':'rnn'}
    ...
    script_params = {
        ...
        '--arch':  MODEL[DATASET],
        '--mlp_num_layers': 2,
        '--mlp_hidden_size': 200 if 'mnist' in DATASET else 50,
        '--rnn_hidden_size': 50,
        '--rnn_seq_len': 50,
        '--avg_model': True,
        '--experiment': 'demo',
...
if __name__ == "__main__":
  ...
  parser.add_argument('-E', '--fed_personal', action='store_true')
  parser.add_argument('-Q', '--qffl_q', default=0.0, type=float)
  parser.add_argument('-I', '--dirichlet', action='store_true')
